...
def _parameter_l1(proc_params: Dict[str, Any], inf_params: Dict[str, Any], part_type: str) -> float:
    vals = []
...
def evaluate_consistency(workdir: str) -> Dict[str, Any]:
    ...
    for uid in uids:
        ...
        row = {
            ...
            "parameter_l1": _parameter_l1(proc_params, inf_params, str(jd.get("part_type", "unknown"))),
