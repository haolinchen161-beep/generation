...
Notes:
  ...
  - procedural_expected_face_groups keep face_ids empty; procedural_face_groups is only a compatibility alias.
  - Face id fill/alignment should be done by the later B-Rep weak semantic parser.
"""
...
def write_sample(pt,idx,out_dataset,rng,mesh_deflection):
    ...
    try:
        ...
        write_json(js,{
            ...
            "procedural_expected_face_groups":groups,
            "procedural_face_groups":groups,
            "procedural_components":comps,
            "topology_mechanisms":mechs,
            "semantic_label_note":"configuration_graph/procedural_expected_face_groups are procedural supervision labels. procedural_face_groups is a compatibility alias; face_ids are empty and should be inferred/aligned by the later B-Rep weak semantic parser."
        })
