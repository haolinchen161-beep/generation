...
def _extract_surface_types_from_split_solid(split_solid: Any) -> Tuple[np.ndarray, np.ndarray]:
...
def _parse_step_dtg(step_path: str) -> Dict[str, Any]:
    ...
    with warnings.catch_warnings(), redirect_stderr(io.StringIO()), redirect_stdout(io.StringIO()):
        ...
        surface_types, curvature_proxy = _extract_surface_types_from_split_solid(split_solid)
