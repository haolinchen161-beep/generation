# -*- coding: utf-8 -*-
"""Face-level geometric/topological evidence extraction for motif graph M."""
    ...
    for i, j in combinations(range(face_count), 2):
        ...
        if absdot >= parallel_cos:
            ...
            if normal_gap >= opposite_gap_min:
                ...
                evidence["orientation_status"] = "opposed_normals" if dot < 0 else "undirected_parallel_separated"
